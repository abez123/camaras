...
class CreatePatrocinadoresTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Patrocinadores", 'patrocinadores', 'nombrepatroc', 'fa-bullhorn', [
            ["nombrepatroc", "Nombre comercial", "Name", false, "", 0, 256, false],
            ["logopatroc", "Logo", "Image", false, "", 0, 0, false],
