...
Convocatorio de comités de AMCHM Guadalajara
</div>
...
<tr>
<td align="center" style="border-radius: 3px;" bgcolor="#256F9C"><a href="{{ url('/asistencias/email/'.$convocatoria_id) }}" target="_blank" style="font-size: 16px; font-family: Helvetica, Arial, sans-serif; color: #ffffff; text-decoration: none; color: #ffffff; text-decoration: none; border-radius: 3px; padding: 15px 25px; border: 1px solid #256F9C; display: inline-block;" class="mobile-button">Asistiré &rarr;</a></td>
</tr>
</table>
</td>
</tr>
