...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $comite_aviso->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Comite_Avisos", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/comite_avisos/'.$comite_aviso->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Comite_Avisos", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.comite_avisos.destroy', $comite_aviso->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/comite_avisos') }}" data-toggle="tooltip" data-placement="right" title="Back to Comite Avisos"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'comite')
						@la_display($module, 'tipo')
						@la_display($module, 'titulo')
						@la_display($module, 'aviso')
						@la_display($module, 'minuta')
						@la_display($module, 'archivos')
						@la_display($module, 'video')
						@la_display($module, 'seguimimiento')
						@la_display($module, 'escritopor')
					</div>
				</div>
			</div>
		</div>
