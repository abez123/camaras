...
<div id="page-content" class="profile2">
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/eventos') }}" data-toggle="tooltip" data-placement="right" title="Back to Eventos"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'cuotasocio')
						@la_display($module, 'cuotanosocio')
						@la_display($module, 'ubicacion')
						@la_display($module, 'presentacion')
						@la_display($module, 'video')
						@la_display($module, 'contacto')
						@la_display($module, 'patrocinadores')
