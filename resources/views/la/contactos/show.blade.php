...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $contacto->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Contactos", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/contactos/'.$contacto->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Contactos", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.contactos.destroy', $contacto->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/contactos') }}" data-toggle="tooltip" data-placement="right" title="Back to Contactos"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'apellidop')
					    @la_display($module, 'apellidom')
						@la_display($module, 'tel')
						@la_display($module, 'extension')
						@la_display($module, 'cel')
						@la_display($module, 'whatsapp')
						@la_display($module, 'correo')
						@la_display($module, 'empresa')
						@la_display($module, 'puesto')
						@la_display($module, 'fechanacimiento')
					</div>
				</div>
			</div>
		</div>
