...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $perfildepuesto->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("PerfilDePuestos", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/perfildepuestos/'.$perfildepuesto->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("PerfilDePuestos", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.perfildepuestos.destroy', $perfildepuesto->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/perfildepuestos') }}" data-toggle="tooltip" data-placement="right" title="Back to PerfilDePuestos"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'empresa_id')
						@la_display($module, 'titulo')
						@la_display($module, 'departamento')
						@la_display($module, 'funcion')
						@la_display($module, 'nivel')
						@la_display($module, 'puestoreporta')
						@la_display($module, 'puestoreportedirect')
						@la_display($module, 'puestoreporteindire')
						@la_display($module, 'descripcionobjetivo')
						@la_display($module, 'descripcionfuncion')
						@la_display($module, 'elemtonivel')
						@la_display($module, 'elemtoniveltec')
					</div>
				</div>
			</div>
		</div>
