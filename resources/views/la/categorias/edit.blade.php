			...
			<div class="col-md-8 col-md-offset-2">
				{!! Form::model($categoria, ['route' => [config('laraadmin.adminRoute') . '.categorias.update', $categoria->id ], 'method'=>'PUT', 'id' => 'categoria-edit-form']) !!}
					...
					<div class="form-group">
						{!! Form::submit( 'Actualizar', ['class'=>'btn btn-success']) !!} <button class="btn btn-default pull-right"><a href="{{ url(config('laraadmin.adminRoute') . '/categorias') }}">Cancelar</a></button>
					</div>
				{!! Form::close() !!}
			</div>
		</div>
