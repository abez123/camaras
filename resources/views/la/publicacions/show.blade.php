...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $publicacion->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Publicacions", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/publicacions/'.$publicacion->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Publicacions", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.publicacions.destroy', $publicacion->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/publicacions') }}" data-toggle="tooltip" data-placement="right" title="Back to Publicacions"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'perfil_id')
						@la_display($module, 'titulopub')
						<p>
						@la_display($module, 'texto')</p>
						<div class="row">
                        <div class="col-md-6">
                            <a href="https://oficinaexpress.occ.com.mx/Vacante/Crear" target="_blank"><img src="/la-assets/img/logoocc.png" class="img-responsive center-block"></a>
                                            <br>
                                            <a href="https://employers.indeed.com/m#jobs" target="_blank"><img src="/la-assets/img/indeedlogo.png" class="img-responsive center-block"></a>
                                                 <br>
                                            <a href="http://empresa.computrabajo.com.mx/" target="_blank"><img src="/la-assets/img/computrabajologo.png" class="img-responsive center-block"></a>
                                                    <br>
                            <a href="https://www.empleo.gob.mx/empresas" target="_blank"><img src="/la-assets/img/logo_stps.png" class="img-responsive center-block"></a>
                            <br>
