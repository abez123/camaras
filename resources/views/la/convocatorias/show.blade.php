...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $convocatoria->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Convocatorias", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/convocatorias/'.$convocatoria->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Convocatorias", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.convocatorias.destroy', $convocatoria->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/convocatorias') }}" data-toggle="tooltip" data-placement="right" title="Back to Convocatorias"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'comite_id')
						@la_display($module, 'tituloconvactoria')
					
						@la_display($module, 'horario')
						@la_display($module, 'sedenombre')
						@la_display($module, 'sededomicilio')
						@la_display($module, 'preciosocio')
						@la_display($module, 'precionosocio')
						@la_display($module, 'temario')
						@la_display($module, 'temarioimagen')
						@la_display($module, 'expositor')
						@la_display($module, 'archivos')
						@la_display($module, 'logoexpositor')
