...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $licitacion->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Licitacions", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/licitacions/'.$licitacion->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Licitacions", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.licitacions.destroy', $licitacion->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/licitacions') }}" data-toggle="tooltip" data-placement="right" title="Back to Licitacions"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'codigoexp')
						@la_display($module, 'descripcionexp')
						@la_display($module, 'descripcionanuncio')
						@la_display($module, 'notas')
						@la_display($module, 'plazo')
						@la_display($module, 'archiosconv')
						@la_display($module, 'responsble')
