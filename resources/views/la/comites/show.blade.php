...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $comite->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Comites", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/comites/'.$comite->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Comites", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.comites.destroy', $comite->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/comites') }}" data-toggle="tooltip" data-placement="right" title="Back to Comites"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'objetivos')
						@la_display($module, 'temas')
						@la_display($module, 'fechassesion')
						@la_display($module, 'presidente')
						@la_display($module, 'vicepresidente')
						@la_display($module, 'coordinador')
						@la_display($module, 'miembros')
						@la_display($module, 'activo')
					</div>
				</div>
			</div>
		</div>
