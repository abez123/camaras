...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $evaluacion->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Evaluacions", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/evaluacions/'.$evaluacion->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Evaluacions", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.evaluacions.destroy', $evaluacion->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/evaluacions') }}" data-toggle="tooltip" data-placement="right" title="Back to Evaluacions"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'candidato_id')
						@la_display($module, 'proveedorsocio')
						@la_display($module, 'archivosocio')
						@la_display($module, 'socio')
						@la_display($module, 'psicometrico')
						@la_display($module, 'proveedorpsico')
						@la_display($module, 'archivopsico')
						@la_display($module, 'medico')
						@la_display($module, 'proveedormed')
						@la_display($module, 'archivomed')
						@la_display($module, 'observaciones')
