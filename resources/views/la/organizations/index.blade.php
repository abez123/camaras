...
@section("contentheader_description", "Organizations lista")
@section("section", "Organizations")
@section("sub_section", "Lista")
@section("htmlheader_title", "Organizations Lista")

@section("headerElems")
@la_access("Organizations", "create")
	<button class="btn btn-success btn-sm pull-right" data-toggle="modal" data-target="#AddModal"><i class="fa fa-plus"></i> Organization</button>
@endla_access
@endsection
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel"><i class="fa fa-plus"></i> Organization</h4>
			</div>
