...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $screening->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Screenings", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/screenings/'.$screening->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Screenings", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.screenings.destroy', $screening->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/screenings') }}" data-toggle="tooltip" data-placement="right" title="Back to Screenings"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'candidato')
						@la_display($module, 'edad')
						@la_display($module, 'familia')
						@la_display($module, 'escolaridad')
						@la_display($module, 'lugaractual')
						@la_display($module, 'disponibilidad')
						@la_display($module, 'labora')
						@la_display($module, 'comptencias')
						@la_display($module, 'observaciones')
						@la_display($module, 'tiposcreen')
