...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $encuesta->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Encuestas", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/encuestas/'.$encuesta->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Encuestas", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.encuestas.destroy', $encuesta->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/encuestas') }}" data-toggle="tooltip" data-placement="right" title="Back to Encuestas"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'convocatoria_id')
						@la_display($module, 'impresion')
						@la_display($module, 'CalificarPres')
						@la_display($module, 'organizacion')
						@la_display($module, 'programacion')
						@la_display($module, 'sede')
						@la_display($module, 'contenido')
						@la_display($module, 'manejo')
						@la_display($module, 'expectativa')
						@la_display($module, 'gusto')
						@la_display($module, 'mejorar')
						@la_display($module, 'miembro_id')
					</div>
				</div>
			</div>
		</div>
