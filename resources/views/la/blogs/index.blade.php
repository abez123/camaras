...
@section("contentheader_description", "Blogs lista")
@section("section", "Blogs")
@section("sub_section", "Lista")
@section("htmlheader_title", "Blogs Lista")

@section("headerElems")
@la_access("Blogs", "create")
	<button class="btn btn-success btn-sm pull-right" data-toggle="modal" data-target="#AddModal"><i class="fa fa-plus"></i> Blog</button>
@endla_access
@endsection
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel"><i class="fa fa-plus"></i> Blog</h4>
			</div>
