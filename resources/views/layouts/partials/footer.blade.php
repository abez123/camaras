  ...
  <div class="container">
    <div class="row">
      <div class="col-md-3 col-sm-6"> <a href="#" class="logo"><img src="http://localhost/ancham/public/socio-assets/images/logo.png" alt=""></a>
        <ul class="contact-info has-bg-image contain" data-bg-image="http://localhost/ancham/public/socio-assets/images/footer-map-bg.png">
      ...
      <div class="col-md-3 col-sm-6">
        ...
        <ul class="photos-list">
          <li><img src="http://localhost/ancham/public/socio-assets/images/photostream4.jpg" alt=""></li>
          <li><img src="http://localhost/ancham/public/socio-assets/images/photostream6.jpg" alt=""></li>
          <li><img src="http://localhost/ancham/public/socio-assets/images/photostream3.jpg" alt=""></li>
          <li><img src="http://localhost/ancham/public/socio-assets/images/photostream2.jpg" alt=""></li>
          <li><img src="http://localhost/ancham/public/socio-assets/images/photostream1.jpg" alt=""></li>
          <li><img src="http://localhost/ancham/public/socio-assets/images/photostream.jpg" alt=""></li>
        </ul>
      </div>
      <div class="col-md-3 col-sm-6">
        <h5>Newsletter</h5>
